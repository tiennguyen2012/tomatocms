 ...
 * @version 	$Id: Config.php 1204 2010-02-09 07:13:40Z hoangninh $
 */

class Tomato_Core_Config 
{
	const KEY = 'Tomato_Core_Config_';
	...
	public static function getConfig() 
	{
		...
		if (!Zend_Registry::isRegistered($key)) {
			$defaultConfig = TOMATO_APP_DIR.DS.'config'.DS.'app.ini';
